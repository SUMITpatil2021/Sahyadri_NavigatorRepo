...
export default function AddTrekkWithImage() {
    ...
    const handleSubmit = (e) => {
        ...
        const reqOptions = {
            ...
            body: JSON.stringify({
                trekkname: state.trekData.trekName,
        ...
        fetch('http://localhost:8080/addTrekk', reqOptions)
            ...
            .then((data) => {
                ...
                fetch('http://localhost:8080/addImage', reqOptions1)
                    .then((resp) => resp.text())
                    .then((data) => {
                        if (data === "Image addedd successsfully") {
                            alert("Trekk details added successfully");
                        }
                        else {
